...
submitted = st.button("✅ 제출하기", key="widget_submitted")

st.markdown("---")

st.subheader("📊 실시간 응답 요약")

# 위젯 값들을 버튼으로 누르지 않아도 조작하는 즉시 바로 갱신된다
# 이름: 홍길동/ 나이: 25세
